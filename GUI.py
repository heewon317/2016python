...
class Ui_Dialog(object):
	def setupUi(self, Dialog):
		...
		self.pushButton_Mail = QtWidgets.QPushButton(self.horizontalLayoutWidget_2)
		#font = QtGui.QFont()
		#font.setFamily("굴림")
		#font.setPointSize(10)
		#self.pushButton_Mail.setFont(font)
		self.pushButton_Mail.setIconSize(QtCore.QSize(16,16))
		self.pushButton_Mail.setAutoRepeatDelay(300)
		self.pushButton_Mail.setAutoRepeatInterval(100)
	...
	def retranslateUi(self, Dialog):
		...
		self.pushButton_Mail.setText(_translate("Dialog", "메일 보내기"))
